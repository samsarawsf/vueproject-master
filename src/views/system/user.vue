...
<template>
  <div>
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading"
      ...
      <el-table-column align="center" sortable prop="role.name" label="角色" width="120">
      </el-table-column>
      ...
      <el-table-column label="操作" min-width="300">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success" @click="dataAccess(scope.$index, scope.row)">分配角色</el-button>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">  <!--这一行删除了:rules="rules" 正则匹配-->
...
import {
  ...
  UserDeptSave,
  UserDeptdeptTree,
  UserChangeDept, roleList, checkUserName
} from '../../api/userMG'
